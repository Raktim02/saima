...
const displayContent = (text) => {
  ...
  let readText = text.length < 30 ? text : text.slice(0, 30) + "<span class='fw-bold read-more'>... read more</span>";

  // let read = document.querySelectorAll(".read-more");
  // read.forEach(button => {
  //   button.addEventListener("click", () => {
  //       let parentEle = button.parentElement;
  //       parentEle.innerHTML = textValue
  ...
  div.innerHTML = `
              ...
              <div class="post__footer">
                <div class="post__buttons">
                  <button class="post__button" onclick = "favorite(this)">
                ...
                <div class="post__content post-comment">${displayContent(post.description)}</div>
